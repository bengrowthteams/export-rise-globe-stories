    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="mb-24">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative">
                <div className="absolute -inset-4 bg-gradient-to-r from-green-400 to-blue-400 rounded-2xl opacity-20 blur-xl"></div>
                <img 
                  ...
                  className="relative w-full h-80 object-cover rounded-2xl shadow-2xl border-4 border-white"
                />
              </div>
            </div>
          </div>
          ...
          <div className="mb-24">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="relative lg:order-first">
                <div className="absolute -inset-4 bg-gradient-to-r from-blue-400 to-green-400 rounded-2xl opacity-20 blur-xl"></div>
                <img 
          ...
          <div className="text-center bg-gradient-to-r from-green-600 to-blue-600 rounded-3xl p-12 shadow-2xl">
            <div className="max-w-4xl mx-auto">
              <h3 className="text-4xl font-bold text-white mb-6">
                Explore the breakthroughs
              </h3>
              <p className="text-xl text-green-50 leading-relaxed mb-10">
              ...
              <Button 
                ...
                size="lg"
                className="bg-white text-green-600 hover:bg-green-50 px-10 py-4 text-xl font-bold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
              >
