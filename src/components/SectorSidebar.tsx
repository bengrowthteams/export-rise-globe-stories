...
const SectorSidebar: React.FC<SectorSidebarProps> = ({
  ...
  return (
    <div className="w-full sm:w-80 bg-white border-r border-gray-200 shadow-lg overflow-y-auto">
      <div className="p-3 sm:p-4 border-b border-gray-200">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center space-x-2 sm:space-x-3">
            <span className="text-xl sm:text-2xl">{countryStories.flag}</span>
            <h2 className="text-base sm:text-lg font-bold">{countryStories.country}</h2>
          </div>
          <button
            onClick={onClose}
