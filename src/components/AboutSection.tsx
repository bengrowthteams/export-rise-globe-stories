    ...
    <div id="about-section" className="bg-gradient-to-br from-gray-50 via-white to-blue-50/30 py-24 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold text-gray-900 mb-6">About</h2>
        ...
        <section className="mb-16">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
            <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
              <p>
                The <b>Sector Transformation Atlas</b> documents and maps 82 export booms since 1995 that have reshaped economies around the world.
              </p>
              <p>
