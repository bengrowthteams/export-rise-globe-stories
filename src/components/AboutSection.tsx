              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border border-green-200 shadow-sm">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="font-mono text-base leading-relaxed bg-gradient-to-r from-green-700 to-emerald-600 bg-clip-text text-transparent">
                    <a href="https://www.growth-teams.org" target="_blank" rel="noopener noreferrer" className="text-gray-900 hover:underline">Growth Teams</a>. (2025). Sector Transformation Atlas. [<a href="https://www.growth-teams.org" target="_blank" rel="noopener noreferrer" className="text-gray-900 hover:underline">www.growth-teams.org</a>]
                  </p>
                </div>
              </div>
            </div>
